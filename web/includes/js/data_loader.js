...
function data_loader_loadCategories(){
	categories[0] = {
		...
		image_file_name: "includes/images/theatrenotepaper.png"
	};
	categories[1] = {
		id: 1,
		name: "landmark",
		title: "Visit a landmark",
		image_file_name: "includes/images/landmarknotepaper.png"
	};
	categories[2] = {
		id: 2,
		name: "outdoors",
		title: "Something outdoorsy",
		image_file_name: "includes/images/outdoorsnotepaper.png"
	};
	categories[3] = {
		id: 3,
		name: "restaurant",
		title: "Eat a nice meal",
		image_file_name: "includes/images/restaurantnotepaper.png"
	};
	categories[4] = {
		id: 4,
		name: "daytrip",
		title: "Take a day trip",
		image_file_name: "includes/images/daytripnotepaper.png"
	};
	categories[5] = {
		id: 5,
		name: "all",
		title: "Everything!",
		image_file_name: "includes/images/allnotepaper.png"
	};
	categories[6] = {
		id: 6,
		name: "surprise",
		title: "Surprise me!",
		image_file_name: "includes/images/surprisemenotepaper.png"
	};
	categories[7] = {
		id: 7,
		name: "custom",
...
function data_loader_loadAvailableDestinations(){
	...
	**/
	available_destinations[0] = {
				...
				image_file_name_small: "includes/images/londoneye_small.jpg",
				image_file_name_large: "includes/images/londoneye.jpg",
	...
	available_destinations[1] = {
				...
				image_file_name_small: "includes/images/lionking_small.jpg",
				image_file_name_large: "includes/images/lionking.jpg",
	...
	available_destinations[2] = {
				...
				image_file_name_small: "includes/images/harrypottertour_small.jpg",
				image_file_name_large: "includes/images/harrypottertour.jpg",
	...
	available_destinations[3] = {
				...
				image_file_name_small: "includes/images/medievalbanquet_small.jpg",
				image_file_name_large: "includes/images/medievalbanquet.jpg",
	...
	available_destinations[4] = {
				...
				image_file_name_small: "includes/images/londonzoo_small.jpg",
				image_file_name_large: "includes/images/londonzoo.jpg",
	...
	available_destinations[5] = {
				...
				image_file_name_small: "includes/images/epsomdowns_small.jpg",
				image_file_name_large: "includes/images/epsomdowns.jpg",
