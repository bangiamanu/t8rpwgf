...
function populateCalendar(){	
    ...
    var date = new Date(startDateField[2],startDateField[1]-1,startDateField[0]);
...
function addEvent(event_id){
    ...
    // stupid code needed because the internal calendar array starts at 1. So we start the calender_events array at 1
    var cal_event_id;
    if (calendar_events.length == 0)
        cal_event_id = 1
    else
        cal_event_id = calendar_events.length;
